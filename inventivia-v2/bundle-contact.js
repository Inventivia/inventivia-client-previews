...
@media(prefers-reduced-motion:reduce){.sn-link,.sn-cta{transition:none}}`;
  ...
  function Channels() {
    const cards = [
      ...
      { tag: "02 / DE VIVA VOZ", glyph: "\u260E", title: "Ll\xE1manos", body: "\xBFPrefieres hablar? Cu\xE9ntanos tu idea por tel\xE9fono y la aterrizamos contigo al momento.", action: "Enviar email", href: "tel:+34600000000", accent: "var(--signal)" },
