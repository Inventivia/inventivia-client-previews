(function () {
    ...
    var services = {
        ...
        extra: {
            title: 'Limpiezas extra', scope: 'Cristales, suelos y grandes superficies', frequency: 'Servicio programado',
        ...
        mantenimiento: {
            ...
            images: ['home/projects/proyecto_10.jpg', 'trabajos/trabajos-06.jpg', 'home/projects/proyecto_11.jpg']
        },
        jardineria: {
        ...
        conserjeria: {
            ...
            images: ['trabajos/trabajos-09.jpg', 'trabajos/trabajos-06.jpg', 'home/projects/proyecto_12.jpg']
        }
    };
    ...
    document.querySelector('[data-service-info]').innerHTML = '<div><dt>Dirigido a</dt><dd>' + service.scope + '</dd></div><div><dt>Modalidad</dt><dd>' + service.frequency + '</dd></div><div><dt>Zona</dt><dd>Región de Murcia</dd></div><div><dt>Presupuesto</dt><dd>Gratuito y personalizado</dd></div>';
}());
