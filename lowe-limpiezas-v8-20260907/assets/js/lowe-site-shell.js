(function () {
    ...
    function footerMarkup() {
        return '<div class="site-footer__shape-bg float-bob-y" style="background-image:url(assets/images/shapes/site-footer-shpae-bg.png)"></div>' +
            ...
            '<div class="site-footer__widget-box"><div class="row"><div class="col-lg-4 col-md-4"><div class="footer-widget__quick-links"><h4 class="footer-widget__title">Navegación</h4><ul class="footer-widget__quick-links-list list-unstyled"><li><a href="index.html"><span class="icon-next"></span>Inicio</a></li><li><a href="servicios.html"><span class="icon-next"></span>Servicios</a></li><li><a href="nosotros.html"><span class="icon-next"></span>Nosotros</a></li><li><a href="promos.html"><span class="icon-next"></span>Promos</a></li><li><a href="trabajos.html"><span class="icon-next"></span>Trabajos</a></li><li><a href="contacto.html"><span class="icon-next"></span>Contacto</a></li></ul></div></div>' +
            '<div class="col-lg-4 col-md-4"><div class="footer-widget__quick-links"><h4 class="footer-widget__title">Información</h4><ul class="footer-widget__quick-links-list list-unstyled"><li><a href="faq.html"><span class="icon-next"></span>Preguntas frecuentes</a></li><li><a href="opiniones.html"><span class="icon-next"></span>Opiniones</a></li><li><a href="clientes.html"><span class="icon-next"></span>Clientes</a></li><li><a href="calidad-medio-ambiente.html"><span class="icon-next"></span>Calidad y medio ambiente</a></li></ul></div></div>' +
            '<div class="col-lg-4 col-md-4"><div class="footer-widget__services"><h4 class="footer-widget__title">Servicios</h4><ul class="footer-widget__quick-links-list list-unstyled"><li><a href="servicio-detalle.html?servicio=limpieza"><span class="icon-next"></span>Limpieza integral</a></li><li><a href="servicio-detalle.html?servicio=extra"><span class="icon-next"></span>Limpiezas extra</a></li><li><a href="servicio-detalle.html?servicio=plagas"><span class="icon-next"></span>Control de plagas</a></li><li><a href="servicio-detalle.html?servicio=jardineria"><span class="icon-next"></span>Jardinería y piscinas</a></li></ul></div></div></div></div></div></div></div></div>' +
    ...
    function normaliseFooter() {
        document.querySelectorAll('footer.site-footer').forEach(function (footer) {
            footer.classList.add('lowe-footer-v8');
    ...
    function setVerifiedSocialLink() {
        document.querySelectorAll('.main-menu__top-social a[aria-label="LinkedIn"]').forEach(function (link) {
            link.href = 'https://es.linkedin.com/in/lowelimpiezas';
            link.target = '_blank';
            link.rel = 'noopener noreferrer';
        });
        document.querySelectorAll('.main-menu__top-social a[aria-label="Facebook"], .main-menu__top-social a[aria-label="Instagram"]').forEach(function (link) {
            link.hidden = true;
        });
    }
