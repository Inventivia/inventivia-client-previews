...
(function () {
  ...
  document.querySelectorAll('.main-menu__btn-box').forEach(function (box) {
    if (box.querySelector('.lowe-whatsapp-header')) {
      return;
    }

    var link = document.createElement('a');
    link.className = 'lowe-whatsapp-header';
    link.href = whatsappUrl;
    link.target = '_blank';
    link.rel = 'noopener noreferrer';
    link.setAttribute('aria-label', 'Contactar con Lowe por WhatsApp');
...
(function () {
  ...
  button.href = 'https://wa.me/34648672359?text=' + encodeURIComponent('Hola Lowe Limpiezas, quiero solicitar presupuesto');
